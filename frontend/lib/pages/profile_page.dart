            ...
            children: [
              ...
              GestureDetector(
                ...
                child: MultilingualText(
                  ...
                  style: TextStyle(
                    color: _glowColor, // Используем _glowColor для светлого текста
                    fontSize: 16,
  ...
  Widget _buildHeader(BuildContext context) {
    return Row(
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              MultilingualText(
                ...
                isEnglish: _isEnglish,
                style: TextStyle(
                  color: _glowColor.withOpacity(0.8), // Полупрозрачный _glowColor
                  fontSize: 14,
                ),
              ),
            ],
        ...
        IconButton(
          icon: Icon(Icons.logout, color: _glowColor), // Иконка также светлая
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: MultilingualText(
            ...
            isEnglish: _isEnglish,
            style: TextStyle(color: _glowColor), // Светлый текст
          ),
          content: MultilingualText(
            russian: 'Вы уверены, что хотите выйти из профиля?',
            english: 'Are you sure you want to log out?',
            isEnglish: _isEnglish,
            style: TextStyle(color: _glowColor.withOpacity(0.8)), // Полупрозрачный светлый текст
          ),
          actions: [
            TextButton(
              child: MultilingualText(
            ...
            TextButton(
              child: MultilingualText(
                ...
                english: 'Logout',
                isEnglish: _isEnglish,
                style: TextStyle(color: _tertiaryColor), // Яркий акцентный цвет
              ),
              onPressed: () {
...
class MultilingualText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      style: style?.copyWith(fontFamily: isEnglish ? 'Tomorrow' : 'Cornerita'),
    );
  }
}